<?php
	...
	echo ("
		<p class=\"work\">
			Modifiez cet enchazaînement de scripts afin d'afficher pour chaque dossier, en plus des informations déjà fournies, sa date d'émission et pour chacune des places associés, le nom, la forme, la catégorie et la date de l'épreuve'.
		</p>
	");
