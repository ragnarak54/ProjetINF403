...
FROM LesBillets natural join LesEpreuves join lesdossiers using (ndossier)
WHERE nDossier = :n group by dateEmission, nEpreuve, nomE, forme, categorie, dateEpreuve order by 1
	");
